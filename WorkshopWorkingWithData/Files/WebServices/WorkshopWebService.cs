...
namespace WorkshopWorkingWithData
{
    ...
    public class WorkshopWebService : BaseService
    {
        ...
        {
            //http://localhost:5000/rest/WorkshopWebService/GetAllContacts?qt=0
            Timer.Start();
        ...
        {
            //http://localhost:5000/0/rest/WorkshopWebService/GetFilteredContacts?qt=0&email=kirill.krylov@gmail.com	
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        // Example to run: 
        // http://localhost:5000/0/rest/WorkshopWebService/GetAllDataReverseJoin?qt=1
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        {
            // http://localhost:5000/rest/WorkshopWebService/GetContactsWithMinutes?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00
            Timer.Start();
            Tuple<DataTable, string> result;
            switch (qt)
            {
        ...
        {
            // http://localhost:5000/rest/WorkshopWebService/UpdateContactName?qt=1&ContactId=410006e1-ca4e-4502-a9ec-e54d922d2c00&NewName=Kirill
            Timer.Start();
        ...
        {
            // http://localhost:5000/rest/WorkshopWebService/InsertSeveralContacts?qt=1
            Timer.Start();
            string result = string.Empty;
            switch (qt)
            {
        ...
        {
            // http://localhost:5000/rest/WorkshopWebService/DeleteContact?qt=1&ContactId=060b93d0-0b94-4967-af32-030ac0844ec9
            Timer.Start();
            string result = string.Empty;
            switch (qt)
            {
        ...
        private MemoryStream GetMemoryStream(string htmlPage)
        {
			...
			Terrasoft.Web.Http.Abstractions.HttpContext httpContext = HttpContextAccessor.GetInstance();
